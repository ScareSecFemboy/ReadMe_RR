...
sub hosts_ICMP {
    ...
    my @hosts = `sudo perl modules/perl/files/r6.pl -o discover_icmp -t $CIDR`;
...
sub hosts_TCP {
    $oPad->insert("end","\n");
    $oPad->insert("end","Scanning...\n");
    my @hosts = `sudo perl modules/perl/files/r6.pl -o discover_tcp -t $CIDR`;
    $oPad->insert("end",@hosts);
    return;
}
...
sub hosts_SYN {
    $oPad->insert("end","\n");
    $oPad->insert("end","Scanning...\n");
    my @hosts = `sudo perl modules/perl/files/r6.pl -o discover_syn -t $CIDR`;
    $oPad->insert("end",@hosts);
    return;
}
...
sub hosts_UDP {
    $oPad->insert("end","\n");
    $oPad->insert("end","Scanning...\n");
    my @hosts = `sudo perl modules/perl/files/r6.pl -o discover_udp -t $CIDR`;
    $oPad->insert("end",@hosts);
    return;
}
...
sub port_s_check(){
    $oPad->insert("end","\n");
    my @ret = `sudo perl modules/perl/files/r6.pl -o slashc -e $port -r $host`;
...
sub gifjection(){
    $oPad->insert("end","\n");
    my @ret = `sudo perl modules/perl/files/r6.pl -o gif -f $image -p $payload`;
...
sub webpjection(){
    $oPad->insert("end","\n");
    my @ret = `sudo perl modules/perl/files/r6.pl -o webp -f $image -p $payload`;
    $oPad->insert("end","Injecting Payload -> | $payload | \n");
    $oPad->insert("end","Injecting Image   -> | $image   | \n");
    $oPad->insert("end",@ret) if(scalar(@ret)>0);
    return;
...
sub jpgjection(){
    $oPad->insert("end","\n");
    my @ret = `sudo perl modules/perl/files/r6.pl -o jpg -f $image -p $payload`;
    $oPad->insert("end","Injecting Payload -> | $payload | \n");
    $oPad->insert("end","Injecting Image   -> | $image   | \n");
    $oPad->insert("end",@ret) if(scalar(@ret)>0);
    return;
...
sub bmpjection(){
    $oPad->insert("end","\n");
    my @ret = `sudo perl modules/perl/files/r6.pl -o bmp -f $image -p $payload`;
    $oPad->insert("end","Injecting Payload -> | $payload | \n");
    $oPad->insert("end","Injecting Image   -> | $image   | \n");
    $oPad->insert("end",@ret) if(scalar(@ret)>0);
    return;
